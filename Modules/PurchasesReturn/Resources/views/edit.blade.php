                    ...
                    <div class="card-body">
                        ...
                        <form id="purchase-return-form" action="{{ route('purchase-returns.update', $purchase_return) }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            ...
                                            <option {{ $purchase_return->status == 'Shipped' ? 'selected' : '' }} value="Shipped">Sedang Dikirim</option>
                                            <option {{ $purchase_return->status == 'Completed' ? 'selected' : '' }} value="Completed">Terkirim</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="paid_amount">Jumlah Pembayaran <span class="text-danger">*</span></label>
