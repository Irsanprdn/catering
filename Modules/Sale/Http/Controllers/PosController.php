...
class PosController extends Controller
{
   ...
   public function store(StorePosSaleRequest $request) {
    $saleid = null; // Deklarasikan $saleid di luar transaction untuk memastikan aksesibilitasnya
    ...
    //    return redirect()->route('app.pos.index')->with('success', 'Transaksi Berhasil');
