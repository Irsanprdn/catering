...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">Setelan Sistem</li>
    </ol>
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Setelan Sistem</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('settings.update') }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="company_phone">No. Telepon <span class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="default_currency_id">Input Bawaan <span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="default_currency_position">Posisi Input Bawaan<span class="text-danger">*</span></label>
