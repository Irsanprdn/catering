            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <label for="product_name">Nama Menu <span class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_stock_alert">Stok Minimal <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="product_note">Deskripsi</label>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="image">Gambar Menu <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Max Files: 3, Max File Size: 1MB, Image Size: 400x400"></i></label>
             ...
             <div class="form-group">
                        <button class="btn btn-primary">Update Menu <i class="bi bi-check"></i></button>
                    </div>
        </form>
    </div>
@endsection
