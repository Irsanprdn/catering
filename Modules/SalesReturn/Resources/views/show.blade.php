                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-4 mb-3 mb-md-0">
                                ...
                                <div>Tanggal: {{ \Carbon\Carbon::parse($sale_return->date)->format('d M, Y') }}</div>
                                <div>
                                    Status: <strong>{{ $sale_return->status }}</strong>
                                </div>
                                <div>
                                     Status Pembayaran: <strong>{{ $sale_return->payment_status }}</strong>
                                </div>
                            </div>
