    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <p class="font-italic">Ubah Data Profil & Password Di sini...</p>
            </div>
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('profile.update') }}" method="POST">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary">Update Profil <i class="bi bi-check"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('profile.update.password') }}" method="POST">
                            ...
                            @method('patch')
                            <div class="form-group">
                                <label for="current_password">Password Sebelumnya <span class="text-danger">*</span></label>
