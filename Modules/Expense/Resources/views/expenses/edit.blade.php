    ...
    <div class="container-fluid">
        <form id="expense-form" action="{{ route('expenses.update', $expense) }}" method="POST">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="category_id">Jenis Pengeluaran <span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="amount">Total <span class="text-danger">*</span></label>
             ...
             <div class="form-group">
                        <button class="btn btn-primary">Update Pengeluaran <i class="bi bi-check"></i></button>
                    </div>
        </form>
