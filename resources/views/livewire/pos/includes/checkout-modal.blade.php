    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            Swal.fire({
                ...
                html: 'Cetak Struk..??<br><br><a target="_blank" href="{{ route('sales.pos.pdf', session('transaction_id')) }}" class="btn btn-primary">Cetak</a><button class="btn btn-info" id="btn-kembali">Kembali</button>',
